...
public interface SysUserMapper extends BaseMapper<SysUser> {
     ...
     * @return
     */
    List<SysUserDepDTO> getDepNamesByUserIds(@Param("userIds") List<String> userIds);
     ...
     * @return
     */
    List<SysUserSysDepartDTO> getUserByOrgCode(IPage page, @Param("orgCode") String orgCode, @Param("userParams") SysUser userParams);
