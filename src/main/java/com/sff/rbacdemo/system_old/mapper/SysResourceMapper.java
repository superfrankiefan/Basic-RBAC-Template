...
public interface SysResourceMapper extends BaseMapper<SysResource> {
     ...
     * @return
     */
    public List<CommonTreeDTO> queryListByParentId(@Param("parentId") String parentId);

    /**
     * 根据用户查询用户权限
     */
    public List<SysResource> queryByUser(@Param("username") String username);
     ...
     * @return
     */
    public int queryCountByUsername(@Param("username") String username, @Param("resource") SysResource sysResource);
