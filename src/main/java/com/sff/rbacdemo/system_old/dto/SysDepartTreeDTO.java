 ...
 * <p>
 */
public class SysDepartTreeDTO implements Serializable {
    ...
    private List<SysDepartTreeDTO> children = new ArrayList<>();
     ...
     * @param sysDepart
     */
    public SysDepartTreeDTO(SysDepart sysDepart) {
    ...
    public List<SysDepartTreeDTO> getChildren() {
        return children;
    }

    public void setChildren(List<SysDepartTreeDTO> children) {
        if (children == null) {
            this.isLeaf = true;
        }
    ...
    public boolean equals(Object o) {
        ...
        SysDepartTreeDTO model = (SysDepartTreeDTO) o;
