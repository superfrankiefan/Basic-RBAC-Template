...
//import com.sff.rbacdemo.common.annotation.Dict;
//import com.sff.rbacdemo.common.model.APIResponse;
//import com.sff.rbacdemo.common.utils.ObjConvertUtils;
...
//     */
//    @Pointcut("@annotation(com.sff.rbacdemo.*.controller.*.*(..))")
...
//             * 应该放在redis，提高响应速度
//             */
//            DictDetail dictData = sysDictService.getDictDetailByCodeAndValue(dictType, key);
//            if (dictData.getDetailName() != null) {
//                if (!"".equals(textValue.toString())) {
//                    textValue.append(",");
//                }
//                textValue.append(dictData.getDetailName());
//            }
//            log.info("数据字典翻译: 字典类型：{}，当前翻译值：{}，翻译结果：{}", dictType, k.trim(), dictData.getDetailName());
//        }
